...
# a function filtering out invisible files and sub-folders
    ...
    def _step(self):
        ...
        with self.timers["sample_processing"]:
            ...
            for i, (ev, (sample_batch, count)) in enumerate(completed):
                ...
                #     random.choice(
                #         self.replay_actors).refresh_demos.remote() 
...
class ReplayActor(object):
    ...
    def __init__(self, num_shards, learning_starts, buffer_size,
        ...
        # added by autodesk_rl
        if human_demonstration is True:

            assert human_data_dir is not None, "Missing Human Data Path!"
            assert (multiple_human_data == -1 or multiple_human_data == 0 or multiple_human_data == 1), "multiple_human_data has to be either -1, 0, or 1"

            # no multiple human data
            if multiple_human_data == -1:
            ...
            elif multiple_human_data == 0:
                names = os.listdir(human_data_dir)
            ...
            def new_buffer():
                return PrioritizedReplayBuffer(
                    self.buffer_size, alpha=prioritized_replay_alpha, permanent_data_length=len(human_data), human_data=human_data)
    ...
    def refresh_demos(self):
        ...
        robot_data_dir = "robot_demo_data/"
        ...
        if len(filtered_files) > 0:
            ...
            for policy_id, replay_buffer in self.replay_buffers.items():
                ...
                # replay_buffer.add_demos(demo_data)

                prGreen("The new demo's length: {}".format(replay_buffer._permanent_data_length))
