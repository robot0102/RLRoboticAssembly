# Autodesk Deep Reinforcement Learning
...
1. Create folders and clone repositories.
    ...
    1. Clone [AutodeskRoboticsLab/rllib](https://github.com/AutodeskRoboticsLab/rllib).
    2. In the rllib directory, clone [AutodeskRoboticsLab/autodesk_rl](https://github.com/AutodeskRoboticsLab/autodesk_rl).
...
Input devices are defined in _autodesk_rl/devices_. The base class for an input
